...
from app.routers import auth, bot, briefing, calendar, chat, documents, journal, memory, search, tasks, users
...
# ── API routes ────────────────────────────────────────────────────────────────
for r in [auth, tasks, journal, documents, memory, briefing, search, chat, users, calendar, bot]:
